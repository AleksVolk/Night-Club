 ...
 */
    ...
    (() => {
        ...
        if (inputMasks.length) {
            ...
            const inputTel = document.querySelector(".form-call__input_tel");
        ...
        function initSliders() {
            if (document.querySelector(".main-slider")) new core(".main-slider", {
                modules: [ Navigation, Pagination, Lazy, Keyboard, Autoplay ],
                slidesPerView: 1,
                spaceBetween: 0,
                speed: 600,
                loop: true,
                ...
                navigation: {
                    prevEl: ".main-slider__arrows .main-slider-arrow_prev",
                    nextEl: ".main-slider__arrows .main-slider-arrow_next"
                }
            });
            if (document.querySelector(".news-promo__slider")) new core(".news-promo__slider", {
                modules: [ Navigation, Pagination, Lazy, Keyboard, Autoplay ],
                slidesPerView: 3,
                spaceBetween: 15,
                speed: 600,
                ...
                pagination: {
                    el: ".news-promo__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: ".news-promo__arrows .news-promo-arrow_prev",
                    nextEl: ".news-promo__arrows .news-promo-arrow_next"
                }
            });
        }
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (targetElement.classList.contains("filters-catalog__btn")) {
                    const tagsMenu = document.querySelector(".tags-catalog");
                    targetElement.classList.toggle("_active");
                    tagsMenu.classList.toggle("_active");
                }
                if (targetElement.classList.contains("filters-catalog__btn_bar")) {
                    const tagsMenu = document.querySelector(".tags-catalog_bar");
                    targetElement.classList.toggle("_active");
                    tagsMenu.classList.toggle("_active");
                }
                if (targetElement.classList.contains("categories-catalog__btn")) {
                    const categoriesInput = document.querySelector(".categories-catalog__input");
                    targetElement.classList.toggle("_active");
                    categoriesInput.classList.toggle("_active");
                }
                if (targetElement.classList.contains("tags-catalog__item")) targetElement.classList.toggle("_active");
            }
            if (document.querySelector(".catalog__content")) {
                const menuProducts = document.querySelectorAll(".product");
                const closeBtns = document.querySelectorAll(".product-open__close");
                menuProducts.forEach((menuProduct => {
                    const menuProductsBtn = menuProduct.querySelector(".product__btn");
                    menuProductsBtn.addEventListener("click", (e => {
                        const menuActiveProducts = document.querySelectorAll(".product-open");
                        removeClasses(menuActiveProducts, "_active");
                        const hash = e.target.getAttribute("href").replace("#", "");
                        const menuOpenProduct = document.querySelector(`#${hash}`);
                        menuOpenProduct.classList.add("_active");
                        e.preventDefault();
                    }));
                    menuProductsBtn.addEventListener("mouseenter", (e => {
                        const product = menuProductsBtn.closest(".product");
                        product.classList.add("_active");
                    }));
                    menuProductsBtn.addEventListener("mouseleave", (e => {
                        const product = menuProductsBtn.closest(".product");
                ...
                closeBtns.forEach((closeBtn => {
                    closeBtn.addEventListener("click", (function(e) {
                        const menuOpenProduct = closeBtn.closest(".product-open");
                        menuOpenProduct.classList.remove("_active");
                    }));
                }));
            }
        };
